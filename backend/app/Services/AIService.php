...
2. **スケジュール/時間割の質問**: ユーザーがスケジュールや時間割について聞いた場合:
   - 上記の「週間スケジュール」に記載された授業名・時刻をそのまま使って答えてください
   - 「金曜日の授業は何ですか」「今日の予定は？」などの質問に対応
   - プレースホルダー「[授業リスト]」は絶対に使わないでください。実際の授業名と時刻を列挙すること
   - 例: スケジュールに「金曜日: 09:00 数学, 10:30 英語」がある場合 → 「金曜日の授業は以下の通りです: 09:00 数学、10:30 英語」
   - スケジュールに該当曜日の授業が無い場合 → 「金曜日の授業は登録されていません」と答える
